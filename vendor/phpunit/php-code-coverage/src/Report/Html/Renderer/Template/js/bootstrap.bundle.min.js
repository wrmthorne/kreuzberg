...
!((t, e) => {
	...
	let t = new Map(),
		...
		i = "transitionend",
		n = (t) => (
			t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, (_t, e) => `#${CSS.escape(e)}`)), t
		),
		s = (t) => {
	...
	var qt = "top",
		...
		te = "popper",
		ee = "reference",
		ie = Yt.reduce((t, e) => t.concat([`${e}-${Ut}`, `${e}-${Gt}`]), []),
		ne = [].concat(Yt, [Xt]).reduce((t, e) => t.concat([e, `${e}-${Ut}`, `${e}-${Gt}`]), []),
		se = "beforeRead",
		oe = "read",
		re = "afterRead",
		ae = "beforeMain",
	...
	function Te() {
		...
		return t?.brands && Array.isArray(t.brands)
	...
	function Qe(t) {
		return t.replace(/left|right|bottom|top/g, (t) => Ke[t]);
	}
	var Xe = { start: "end", end: "start" };
	function Ye(t) {
		return t.replace(/start|end/g, (t) => Xe[t]);
	}
	function Ue(t) {
		var e = me(t);
				...
				var s =
						"clippingParents" === e
							? ((t) => {
									...
									return ge(i) ? e.filter((t) => ge(t) && ke(t, i) && "body" !== pe(t)) : [];
								})(t)
							: [].concat(e),
					o = [].concat(s, [i]),
					r = o[0],
	...
	function oi(t, e) {
		...
		var i = e,
			...
			c = void 0 === l ? ne : l,
			h = We(n),
			d = h ? (a ? ie : ie.filter((t) => We(t) === h)) : Yt,
			u = d.filter((t) => c.indexOf(t) >= 0);
		0 === u.length && (u = d);
		var f = u.reduce(
			(e, i) => ((e[i] = si(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[ye(i)]), e),
			{},
		);
	...
	function li(t) {
		return [qt, Kt, Vt, Qt].some((e) => t[e] >= 0);
	}
	const ci = {
			name: "hide",
			enabled: !0,
				...
				h = {
					...
					setOptions: (i) => {
						...
						var r,
							...
							u = ((t) => {
								var e = pi(t);
								return fe.reduce((t, i) => t.concat(e.filter((t) => t.phase === i)), []);
							})(
	...
	class Ki extends W {
		...
		static dataApiKeydownHandler(t) {
			...
			if (e && !i) return;
			t.preventDefault();
			const s = Ki.matches(Pi)
					? Ki
					: z.prev(Ki, Pi)[0] || z.next(Ki, Pi)[0] || z.findOne(Pi, t.delegateTarget.parentNode),
	...
	class us extends W {
		...
		_isAnimated() {
			return this._config.animation || this.tip?.classList.contains(is);
		}
		_isShown() {
			return this.tip?.classList.contains(ns);
		}
		_createPopper(t) {
